    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <a href="{{ url('/admin/addcategories') }}" class="btn btn-success">
                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody id="categoryTable">
                            ...
                            <tr>
                                <td>1</td>
                                <td>
                                    <img src="https://via.placeholder.com/50" alt="Category Image" class="img-thumbnail" style="width: 50px;">
                                </td>
                                <td>Electronics</td>
                                <td>Devices, gadgets, and electronics.</td>
                                <td><span class="badge badge-success">Enabled</span></td>
                                <td>
                                    <a href="{{ url('/admin/editcategories/1') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button class="btn btn-danger btn-sm" onclick="confirmDelete('Electronics')">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ url('/admin/editcategories/2') }}" class="btn btn-warning btn-sm">
                                        <i class="fas fa-edit"></i> Edit
                                    </a>
                                    <button class="btn btn-danger btn-sm" onclick="confirmDelete('Clothing')">
                                        <i class="fas fa-trash"></i> Delete
                                    </button>
                                </td>
                            </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Are you sure you want to delete this category? This action cannot be undone. Please type the category name to confirm.
                <input type="text" id="confirmCategoryName" class="form-control mt-2">
                <input type="hidden" id="categoryNameToDelete">
            </div>
...
<script>
    ...
    function deleteCategory() {
        ...
        if (confirmCategoryName === categoryNameToDelete) {
